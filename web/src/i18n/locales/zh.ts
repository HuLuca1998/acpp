export default {
  ...
  projects: {
    ...
    sessions: "会话数",
    clone: "克隆仓库",
    cloneDesc: "从你所在组织与协作的仓库里挑一个克隆到工作区（不含你个人账号名下的仓库）；也可以直接粘贴仓库地址。",
    cloneUrl: "克隆此地址",
    cloning: "正在克隆…",
    cloneDone: "{{name}} 克隆完成",
    cloneFailed: "克隆失败",
  ...
  identity: {
    inviteTitle: "需要邀请链接",
    inviteDesc: "这台机器的主人可以在「连接」页为你生成一条邀请链接，打开它即可使用。",
    revokedTitle: "无权访问",
  ...
  tenants: {
    title: "局域网访客",
    description: "为局域网里的每个人发一条邀请链接：各自的会话与工作目录互不可见，随时可以关停。你在本机访问，始终拥有全部权限。",
    add: "添加访客",
    ...
    linkCopied: "邀请链接已复制",
    rotate: "重新生成链接",
    rotateConfirm: "「{{name}}」手上的旧链接会立刻失效，需要把新链接重新发给他。会话与工作目录不受影响。",
    enable: "恢复访问",
    disable: "关闭访问",
    enabled: "已恢复访问",
    disabled: "已关闭访问",
    removeTitle: "删除访客",
    removeConfirm: "删除「{{name}}」后他的链接立即失效。已有的会话与工作目录会保留，只有你能看到。",
    removed: "访客已删除",
    empty: "还没有访客",
