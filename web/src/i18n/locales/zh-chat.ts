...
export const zhChat = {
  ...
  quota: {
    ...
    resetsIn: "{{time}} 后重置",
    extra: "额外用量",
    credits: "额度余额 {{balance}}",
    creditsUnlimited: "额度不限量",
    providerNote: "这里的 codex 走的是 {{provider}}，不消耗这份额度。",
    updated: "更新于 {{time}}",
    refresh: "重新获取",
    noWindows: "服务端没有给出限额窗口。",
    expired: "登录态已过期：在终端跑一次 {{cli}} 就会续上。",
    notLoggedIn: "{{cli}} 还没登录。",
    unavailable: "这种登录方式没有套餐额度（API key 或第三方接入）。",
    error: "取不到套餐水位：{{error}}",
  },
  toolStatus: {
    pending: "等待中",
